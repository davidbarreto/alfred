...
_GUIDANCE: dict[str, str] = {
    "A0": (
        ...
        "instruction to reply entirely in {language_name}: write mostly in English; use "
        "{language_name} only for the specific word, phrase, or question he's meant to repeat "
        "or answer, and don't expect free-form replies. Every single {language_name} word or "
        "phrase you give him, with no exceptions, must be immediately followed by its English "
        "translation in parentheses — never leave one untranslated. Pick the phrase/vocabulary "
        "to fit whatever topic or scenario is given rather than defaulting to generic greetings. "
        "After he repeats or answers, briefly confirm whether he got it right (in English), then "
        "always hand him exactly one new short phrase or question to try next, translated the "
        "same way — keep this repeat-and-confirm drill going every turn, don't drift into "
        "free-flowing conversation just because he got one right."
    ),
