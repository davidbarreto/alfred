...
async def execute_command(
    ...
    budget_service: BudgetTargetServiceDep,
    ...
    interview_story_service: InterviewStoryServiceDep,
    interview_prep_service: InterviewPrepQuestionServiceDep,
    ...
    try:
        result: Any = await execute(
            ...
            interview_story_service=interview_story_service,
